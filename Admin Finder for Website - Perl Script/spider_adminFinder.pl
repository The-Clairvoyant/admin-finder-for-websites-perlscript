...
system('cls');
system('spider Web Admin Finder (Hacker Edition)');
system "color 0a";
print"\n";
print "\t>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n";
print "\t>   spider Web Admin Finder 2.0 (Hacker Edition   \n";
print "\t>     Code Updated By      netwrkspider      >\n";
print "\t>       =============================        >\n";
print "\t>           RootError       | hacker         >\n";
print "\t> more >> http://www.netwrkspider.org        >\n";
print "\t>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n";
print "\n";
